...
var ClassDeclaration = /** @class */ (function (_super) {
    ...
    ClassDeclaration.prototype.insertMethods = function (index, structures) {
        ...
        var codes = [];
        try {
            for (var structures_4 = __values(structures), structures_4_1 = structures_4.next(); !structures_4_1.done; structures_4_1 = structures_4.next()) {
                var structure = structures_4_1.value;
                var code = indentationText;
                if (structure.isStatic)
                    code += "static ";
                code += structure.name + "()";
            ...
            try {
                if (structures_4_1 && !structures_4_1.done && (_a = structures_4.return)) _a.call(structures_4);
            }

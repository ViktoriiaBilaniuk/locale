...
var LanguageService = /** @class */ (function () {
    ...
    function LanguageService(global) {
        ...
        var languageServiceHost = {
            ...
            getScriptFileNames: function () { return _this.sourceFiles.map(function (s) { return s.getFilePath(); }); },
            ...
            getDefaultLibFileName: function (options) { return ts.getDefaultLibFilePath(global.compilerOptions); },
            ...
            readFile: function (path, encoding) {
                ...
                return _this.global.fileSystem.readFile(path, encoding);
            },
            fileExists: fileExistsSync,
            directoryExists: function (dirName) { return _this.global.compilerFactory.containsFileInDirectory(dirName) || _this.global.fileSystem.directoryExistsSync(dirName); }
        };
        this.compilerHost = {
            ...
            writeFile: function (filePath, data, writeByteOrderMark, onError, sourceFiles) {
                utils_1.FileUtils.ensureDirectoryExistsSync(_this.global.fileSystem, utils_1.FileUtils.getDirPath(filePath));
            ...
            getCanonicalFileName: function (fileName) { return utils_1.FileUtils.getStandardizedAbsolutePath(fileName); },
    ...
    LanguageService.prototype.resetProgram = function () {
        if (this.program != null)
            this.program.reset(this.sourceFiles.map(function (s) { return s.getFilePath(); }), this.compilerHost);
    };
    /**
    ...
    LanguageService.prototype.getProgram = function () {
        if (this.program == null)
            this.program = new Program_1.Program(this.global, this.sourceFiles.map(function (s) { return s.getFilePath(); }), this.compilerHost);
        return this.program;
    };
    /**
     ...
     * @internal
     */
    LanguageService.prototype.addSourceFile = function (sourceFile) {
     ...
     * @internal
     */
    LanguageService.prototype.removeSourceFile = function (sourceFile) {
        var index = this.sourceFiles.indexOf(sourceFile);
        if (index === -1)
            return false;
     ...
     * @internal
     */
    LanguageService.prototype.getSourceFiles = function () {
        return __spread(this.sourceFiles);
    };
